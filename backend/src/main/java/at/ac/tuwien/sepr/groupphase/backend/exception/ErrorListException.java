 ...
 */
public abstract class ErrorListException extends RuntimeException {

    /**
     * A list of specific error messages related to the validation issues.
     */
    private final List<String> errors;

    /**
     * A brief summary message describing the issue.
     */
    private final String messageSummary;

    /**
     * A descriptor providing context for the error list.
     */
